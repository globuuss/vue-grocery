    ...
    <v-card flat tile class="black white--text py-12 px-5" width="100%">
      <v-row>
        <v-col cols="12" xs="12" sm="6" md="4" class="pa-16">
          <v-toolbar color="transparent" flat>
            ...
            <v-toolbar-title class="ml-4">
              <span class="green--text">e</span> <strong>Groceries</strong>
            </v-toolbar-title>
          </v-toolbar>
        ...
        <v-col cols="12" xs="12" sm="6" md="2">
          ...
          <v-card-text class="grey--text mt-n4">Refer A Friends</v-card-text>
        </v-col>
        ...
        <v-col cols="12" xs="12" sm="6" md="2">
         ...
         <v-col cols="12" xs="12" sm="6" md="2">
          ...
          <v-card-text class="grey--text">Sherzod Gulomov</v-card-text>
          <v-card-text class="grey--text mt-n4">(90)-640-09-66</v-card-text>
          <v-card-text class="grey--text mt-n4">mail@gmail.com</v-card-text>
          <v-card-text class="grey--text mt-n4">t.me/asdix_in</v-card-text>
        </v-col>
